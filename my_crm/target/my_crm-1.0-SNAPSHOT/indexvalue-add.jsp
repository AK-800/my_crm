...
<script type="text/javascript">
    $(function () {
		$.post("${pageContext.request.contextPath}/Datacollect/getAll",function (data) {
				$(data).each(function (index,item) {
					var opt = "<option value=\""+item.daid+"\">"+item.dacname+"</option>"
					$("#com").append(opt)
				})
		})
	})
	...
	function showInfo(val) {
		$.post("${pageContext.request.contextPath}/Datacollect/getInfo",{daid:val},function (data) {
			$(data).each(function (index,item) {
