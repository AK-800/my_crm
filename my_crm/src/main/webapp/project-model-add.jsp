...
<link rel="stylesheet" type="text/css" href="skin/css/base.css">
	...
	<script type="application/javascript">
		$(function () {
			$.post("<%=path%>/Project/getProByFun",function(data) {
				$(data).each(function (index,item) {
					var opt = "<option value='"+item.pid+","+item.pname+"'>"+item.pname+"</option>"
					$("#pro").append(opt)
				})
			})
		})
		...
		function addAna(obj) {
			var id = obj.split(",")[0]
			$.post("<%=path%>/Analysis/getInfoById",{id:id},function(data) {
				alert(data.id)
				$("#inpAna").val(data.id)
				$("#inpMod").val(data.title)
			})
		}
...
<form name="form2" id="form4" action="${pageContext.request.contextPath}/Module/insertMod" method="post">
<input type="hidden" name="analysis_fk" id="inpAna">
...
<tr >
	...
	<td  align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<select id="pro" name="proName" onchange="addAna(this.value)">
...
<tr >
	...
	<td  align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
<%--		<select id="anid" name="analysisFk" style="width: 150px">--%>

<%--		</select>--%>
		<input style="width: 150px" id="inpMod" readonly="readonly">
	</td>
</tr>
<tr >
	<td align="right" bgcolor="#FAFAF1" height="22">模块名称：</td>
	<td  align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<input  name="modname" style="width: 150px"/></td>
</tr>
<tr >
