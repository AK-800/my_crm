...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/skin/css/base.css">
    ...
    <script type="text/javascript">
        $(function () {
            $.post("<%=path%>/Function/queryAll",function(data) {
                $(data).each(function (index,item) {
                    var opt = "<tr align='center' bgcolor=\"#FFFFFF\" onMouseMove=\"javascript:this.bgColor='#FCFDEE';\" onMouseOut=\"javascript:this.bgColor='#FFFFFF';\" height=\"35\" >\n" +
                        "\t<td><input name=\"id\" type=\"checkbox\" id=\"id\" value=\"101\" class=\"np\"></td>\n" +
                        "\t<td>"+item.id+"</td>\n" +
                        "\t<td align=\"center\">"+item.functionname+"</td>\n" +
                        "\t<td align=\"center\">"+item.module.modname+"</td>\n" +
                        "\t<td align=\"center\">"+item.module.analysis.title+"</td>\n" +
                        "\t<td align=\"center\">"+item.module.analysis.project.pname+"</td>\n" +
                        "\t<td>"+item.level+"</td>\n" +
                        "\t<td>2015-02-03</td>\n" +
                        "\t<td>2015-06-03</td>\n" +
                        "\t<td><a href=\"<%=path%>/project-function-edit.jsp?id="+item.id+"\">编辑</a> | <a href=\"<%=path%>/project-function-look.jsp\">查看详情</a></td>\n" +
                        "</tr>\n"
...
<tr>
 <td height="26" background="skin/images/newlinebg3.gif">
  ...
  <td>
    <input type='button' class="coolbg np" onClick="location='<%=path%>/project-function-add.jsp';" value='添加新功能' />
 </td>
 </tr>
</table>
</td>
...
<tr align="center" bgcolor="#FAFAF1" height="22" id="funTr">
	<td width="4%">选择</td>
	<td width="6%">序号</td>
	<td width="10%">功能名称</td>
	<td width="10%">模块名称</td>
