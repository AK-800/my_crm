...
<link rel="stylesheet" type="text/css" href="skin/css/base.css">
	...
	<script type="application/javascript">
		...
		$(function () {
			$.post("${pageContext.request.contextPath}/Baoxiao/getPaymode",function (data) {
				//填充报销类型的下拉框
		...
		//提交报销单
		function commit(){
			$.post("${pageContext.request.contextPath}/Baoxiao/addBx",$("#form9").serialize(),function (data) {
				if(data){
					alert("报销单添加成功！")
...
<form name="form2" action="${pageContext.request.contextPath}/Baoxiao/addBx" id="form9" method="post">
