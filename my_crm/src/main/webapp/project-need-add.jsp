...
<link rel="stylesheet" type="text/css" href="skin/css/base.css">
	...
	<script type="application/javascript">
		$(function () {
			$.get("<%=path%>/Project/getProByAna",function (data) {
...
<form name="form2" action="<%=path%>/Analysis/insertInfo" id="form3" enctype="multipart/form-data" method="post">
...
<tr >
	<td align="right" bgcolor="#FAFAF1" height="22">选择文件：</td>
